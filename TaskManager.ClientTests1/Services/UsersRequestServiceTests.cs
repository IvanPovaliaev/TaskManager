...
namespace TaskManager.Client.Services.Tests
{
    ...
    public class UsersRequestServiceTests
    {
        ...
        public UsersRequestServiceTests()
        {
            ...
            _token = _service.GetToken("admin@admin.com", "qwerty123").Result;
        }

        [TestMethod()]
        public void GetTokenTest()
        {
            var token = _service.GetToken("admin@admin.com", "qwerty123").Result;
        ...
        public void CreateUserTest()
        {
            ...
            var result = _service.CreateUser(_token, userTest).Result;
        ...
        {
            var result = _service.GetAllUsers(_token).Result;
        ...
        {
            var result = _service.DeleteUser(_token, 15).Result;
        ...
        public void CreateMultipleUsersTest()
        {
            ...
            var result = _service.CreateMultipleUsers(_token, [userTest1, userTest2, userTest3]).Result;
        ...
        public void UpdateUserTest()
        {
            ...
            var result = _service.UpdateUser(_token, userTest3).Result;
